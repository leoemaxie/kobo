...
<div class="bg-carbon border border-iron rounded-xl p-8 shadow-sm">
  ...
  >
    <div class="space-y-1.5">
      <label for="name" class="block text-xs font-semibold text-smoke uppercase tracking-widest"
        >Full Name</label
      >
      <input
        id="name"
    ...
    <div class="space-y-1.5">
      <label for="role" class="block text-xs font-semibold text-smoke uppercase tracking-widest"
        >Role</label
      >
      <select
        id="role"
