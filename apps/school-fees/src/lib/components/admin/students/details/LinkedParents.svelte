  ...
  <div class="flex-1 space-y-3 overflow-y-auto mb-4">
    {#if linkedParents.length > 0}
      {#each linkedParents as parent}
        <div
          class="flex items-center justify-between bg-void-black border border-iron/50 rounded-lg p-3"
        >
          <div>
          ...
          >
            ...
            <button
              ...
              class="text-xs text-danger/80 hover:text-danger flex items-center gap-1 transition-colors"
              title="Unlink Parent"
            >
              <Unlink size={14} />
            </button>
    ...
    <div class="mt-auto pt-4 border-t border-iron/50">
      ...
      >
        <select
          name="parentId"
          required
          class="flex-1 bg-void-black border border-iron rounded-lg px-3 py-2 text-sm text-paper focus:outline-none focus:border-electric-lime transition-colors"
        >
        ...
        <button
          type="submit"
          disabled={isSubmitting}
          class="bg-iron/50 hover:bg-iron border border-iron text-pure-white p-2 rounded-lg transition-colors flex items-center justify-center disabled:opacity-50"
        >
          <LinkIcon size={18} />
        </button>
      </form>
