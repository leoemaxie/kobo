...
- **Pending**: The identity has been registered in Kobo, but the virtual account provisioning process is still communicating with Monnify.
...
- **Closed**: The account is fully decommissioned. The underlying virtual account is deactivated at Monnify, and no further operations can occur.
