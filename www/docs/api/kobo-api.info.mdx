...
id: kobo-api
title: "Kobo API"
description: "Kobo provisions and manages persistent, identity-linked virtual accounts. Integrators register identities, receive a dedicated virtual account per identity, and consume reconciled transactions, statements, and lifecycle events through this API. Integrators never call Nomba directly."
...
>
  ...
  >
    ...
    >
      ...
      label={"API Key: NombaWebhookSignature"}
      value={"NombaWebhookSignature"}
    >
