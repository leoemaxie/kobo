...
>
	<div
		class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-10 gap-4 sm:gap-0"
	>
		<div>
			<h1 class="text-2xl font-bold m-0 text-main print:text-black">
				KOBO INC.
			</h1>
			<p class="text-sm mt-1 text-subtle print:text-black">
				Receipt of Payment
			</p>
		</div>
		<div class="text-left sm:text-right">
			<h2 class="text-xl font-bold m-0 text-main print:text-black">
				INVOICE
			</h2>
	...
	<div
		class="flex flex-col sm:flex-row sm:justify-between mb-10 gap-4 sm:gap-0"
	>
		<div>
			<p
				class="text-xs uppercase tracking-widest text-subtle mb-2 print:text-black"
			>
				Billed To
			</p>
	...
	<table class="w-full border-collapse mb-10">
		<thead>
			<tr
				class="border-b border-border-subtle text-left print:border-[#ddd]"
			>
				<th
					class="py-3 text-xs uppercase tracking-widest text-subtle print:text-black"
					>Description</th
				>
				<th
					class="py-3 text-xs uppercase tracking-widest text-subtle text-right print:text-black"
					>Amount</th
				>
			</tr>
		</thead>
		<tbody>
			<tr class="border-b border-border-subtle print:border-[#ddd]">
				<td class="py-4 text-main print:text-black"
					>Platform Usage - {invoice.period}</td
				>
				<td class="py-4 font-mono text-right text-main print:text-black"
					>{invoice.amount}</td
				>
			</tr>
			{#if details}
		...
		<tfoot>
			<tr>
				<td class="pt-6 pb-2 font-bold text-main print:text-black"
					>Total Due</td
				>
				<td
					class="pt-6 pb-2 font-mono text-lg font-bold text-right text-main print:text-black"
					>{invoice.amount}</td
				>
			</tr>
		</tfoot>
	...
	>
		<div>
			<span
				class="text-xs font-bold uppercase py-1 px-2 rounded {invoice.status ===
				'paid'
