...
<div style="background: var(--bg-element); padding: 24px; border-left: 1px solid var(--border-subtle);">
  ...
  <div style="border: 1px solid var(--border-subtle); border-radius: 6px; overflow: hidden;">
    {#each rates as r, i}
      <div style="
        ...
        align-items: center;
      ">
        <span style="font-family: monospace; font-size: 13px; color: var(--text-subtle);">{r.key}</span>
        <div style="text-align: right;">
          <span style="font-family: monospace; font-size: 14px; font-weight: 700; color: #C8C8C8;">{r.unit}</span>
          <span style="font-family: monospace; font-size: 12px; color: var(--text-muted); margin-left: 5px;">{r.label}</span>
        </div>
      </div>
    {/each}
  </div>

  <p style="font-family: monospace; font-size: 12px; color: var(--text-muted); margin: 12px 0 0; line-height: 1.6;">
