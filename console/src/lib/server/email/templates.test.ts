...
describe("Email Templates", () => {
  describe("verificationEmailTemplate", () => {
    it("should generate an email containing the token and default base URL", () => {
      ...
      expect(html).toContain(
        "https://console.kobo.dev/auth/verify-email?token=test-token-123",
      );
    ...
    it("should generate an email with a custom base URL", () => {
      const html = verificationEmailTemplate(
        "token-456",
        "https://custom.kobo.dev",
      );
      expect(html).toContain(
        "https://custom.kobo.dev/auth/verify-email?token=token-456",
      );
    });
  });
  ...
  describe("billingNoticeTemplate", () => {
    ...
    it("should support a custom invoiceUrl", () => {
      const html = billingNoticeTemplate(
        "May 2026",
        "$100.00",
        "https://custom-billing.url",
      );
  ...
  describe("passwordResetTemplate", () => {
    it("should generate an email containing the token and default base URL", () => {
      ...
      expect(html).toContain(
        "https://console.kobo.dev/auth/reset-password?token=reset-token-xyz",
      );
    ...
    it("should generate an email with a custom base URL", () => {
      ...
      expect(html).toContain(
        "https://custom.kobo.dev/auth/reset-password?token=reset-token-abc",
      );
    });
  });
});
