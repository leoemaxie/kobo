...
export const apiIntegrators = pgTable('api_integrators', {
  ...
  walletBalanceKobo: bigint('wallet_balance_kobo', { mode: 'number' }).notNull().default(0),
});
...
export const apiCredentials = pgTable(
  ...
  (table) => [
    ...
    index('idx_api_credentials_integrator_env').on(table.integratorId, table.environment),
  ],
);
