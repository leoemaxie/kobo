...
<div>
  ...
  <div class="border border-border-subtle rounded-lg overflow-x-auto">
    <div class="min-w-[800px]">
      <!-- Header -->
      <div
        class="grid gap-0 bg-sidebar border-b border-border-subtle px-4 py-2.5"
      ...
      {#each keys as k}
        <div
          class="grid items-center px-4 py-3 border-b border-background last:border-b-0 hover:bg-sidebar transition-colors"
          style="grid-template-columns: 1fr 1.4fr 1.6fr 90px 100px 72px;"
        >
