...
<Modal title="Invite Team Member" {onClose}>
  ...
  >
    ...
    <div class="space-y-1.5">
      <label for="role" class="block text-xs font-semibold text-muted uppercase tracking-widest"
        >Role</label
      >
      <select
        id="role"
      ...
      <p class="text-xs text-muted leading-relaxed">
        Owners have full access to billing, settings, and team management. Members can manage API
        keys and webhooks.
      </p>
    </div>
